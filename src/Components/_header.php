...
<head>
    ...
    <link href="http://localhost/code/kartei/dist/output.css" rel="stylesheet">
...
<body class="bg-white dark:bg-slate-900 text-gray-900 dark:text-white min-h-screen ">
    ...
    <nav class="bg-white border-gray-200 dark:bg-slate-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="http://localhost/code/kartei/src/index.php" class="flex items-center">
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Freundeverwaltung</span>
            </a>
